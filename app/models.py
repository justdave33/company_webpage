...
class GeneralInfo(models.Model):
    ...
    # class meta:
    #    db_table = 'custom_table_name' this will change the table name in oyur database
...
class Testimonial(models.Model):
    ...
    def __str__(self) :
        return f"{self.usernname} - {self.user_job_title}"
...
class Blog(models.Model):
    ...
    # on_delete=models.CASCADE - if detailing the author, django will auto delete the authors blogs
    # on_delete = modelss.PROTECT - If deleting the author, django will not allow that if  the author 
